...
export default function Entry({ name, nicename, desc }) {
  return (
    <div className="max-sm:w-3/4 max-2xl:w-1/2 2xl:w-3/12 rotating-border--bland rotating-border m-4 rounded-lg hover:rotating-border--google text-neutral-content backdrop-blur-md">
